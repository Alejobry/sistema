...
<body>
        ...
        <div class="full-width navLateral-body">
            ...
            <nav class="full-width">
                <ul class="full-width list-unstyle menu-principal">
                    ...
                    <li class="full-width divider-menu-h"></li>
                    <li class="full-width">
                        <a href="client.html" class="full-width btn-subMenu">
                            <div class="navLateral-body-cl">
    ...
    <section class="full-width pageContent">
        <section class="full-width text-center" style="padding: 45px 0;">
            <center>
                <style>
                .multicolortext {
               ...
               <h3>
              <span class="multicolortext">|Sistema de control para donaciones de medicinas|
              </span>
              </h3>
              </center>
            ...
            <article class="full-width tile">
                <div class="tile-text">
                    <span class="text-condensedLight">                        
                        <strong><small>INGRESO DE MEDICINAS</strong></small>
                    </span>
                </div>
            ...
            <article class="full-width tile">
                <div class="tile-text">
                    <span class="text-condensedLight">                        
                        <strong><small>DONACIONES DE MEDICINAS</strong></small>
                    </span>
                </div>
                <i class="zmdi zmdi-account tile-icon"></i>
            </article>             
            <article class="full-width tile">
                <div class="tile-text">
                    <span class="text-condensedLight">                        
                        <strong><small>REGISTRO DE USUARIO</strong></small>
                    </span>
                </div>
            ...
            <article class="full-width tile">
                <div class="tile-text">
                    <span class="text-condensedLight">                        
                        <strong><small>BENEFICIARIOS</strong></small>
                    </span>
                </div>
                <i class="zmdi zmdi-label tile-icon"></i>
            </article>
            <article class="full-width tile">
                <div class="tile-text">
                    <span class="text-condensedLight">                        
                        <strong><small>MEDICINAS</strong></small>
                    </span>
                </div>
            ...
            <article class="full-width tile">
                <div class="tile-text">
                    <span class="text-condensedLight">                        
                        <strong><small>PROVEEDORES</strong></small>
                    </span>
                </div>
