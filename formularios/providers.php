			...
			<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--8-col-desktop mdl-cell--2-offset-desktop">
				<div class="full-width panel mdl-shadow--2dp">
					...
					<div class="full-width panel-content">
						<form>
							<h5 class="text-condensedLight"><strong>Datos De Empresa</strong></h5>
							
							<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
								<input class="mdl-textfield__input" type="text" pattern="-?[A-Za-z0-9áéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="NameCompany">
								<label class="mdl-textfield__label" for="NameCompany"><strong>Nombre de la empresa</strong></label>
								<span class="mdl-textfield__error">Invalid nombre de la empresa</span>
							</div>
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
								<input class="mdl-textfield__input" type="number" pattern="-?[0-9]*(\.[0-9]+)?" id="DNICompany">
								<label class="mdl-textfield__label" for="DNICompany"><strong>Número de cédula o ruc</strong></label>
								<span class="mdl-textfield__error">Invalid numero de documento</span>
							</div>
							</div>
							<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
								<input class="mdl-textfield__input" type="text" id="addressCompany">
								<label class="mdl-textfield__label" for="addressCompany"><strong>Dirección</strong></label>
								<span class="mdl-textfield__error">Invalid direccion</span>
							</div>
							<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
								<input class="mdl-textfield__input" type="text" id="addressCompany">
								<label class="mdl-textfield__label" for="addressCompany"><strong>Tipo de Identidad</strong></label>
								<span class="mdl-textfield__error">Invalid tipo identidad</span>
							</div>				
							</form>
					</div>
				</div>
